...
import com.untilled.roadcapture.features.common.ReportBottomSheetDialog
...
fun Fragment.showReportDialog(listener: () -> Unit) {
    ReportBottomSheetDialog(listener).show(childFragmentManager, DialogTagConstant.REPORT_DIALOG)
}
